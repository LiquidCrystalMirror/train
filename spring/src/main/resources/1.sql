/*
 ...
 Source Schema         : train_ticket_system

 Target Server Type    : MySQL
 Target Server Version : 80043 (8.0.43)
 File Encoding         : 65001

 Date: 20/05/2026 22:00:00
*/
...
-- 插入车次站点关联数据（G101：北京南→天津西→济南西→南京南→上海虹桥）
...
-- 插入用户数据（密码为123456的MD5加密值，实际使用时请修改）
...
-- 插入车票数据（G101次列车，二等座车厢1-5排，每排5个座位）
